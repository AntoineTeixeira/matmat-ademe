...
class TestStructureSx:
    """
    Test class for the class StructureSx
    """
    ...
    def test_rows_specs(self, structure_s_x):
        """
        Test property `rows_specs`
        """
        assert structure_s_x.rows_specs == {
            dl.DetailLevelKind.EXTENSION_CATEGORIES: [],
        }

    def test_columns_specs(self, structure_s_x):
        """
        Test property `columns_specs`
        """
        assert structure_s_x.columns_specs == {
