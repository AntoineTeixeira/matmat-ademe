...
class TestNatureCoefficient:
    ...
    def test_disaggregate_sectors(self, mocker):
        ...
        df_output = nature_.disaggregate(
            df=df_input,
    ...
    def test_aggregate_sectors(self, mocker):
        ...
        Expected results:
            Aggregation operation is not allowed for a coefficient.
        ...
        # Patch "apply_bridge_to_df" function of StructureX class
        mock_function = mocker.patch.object(
            structure.StructureX, "apply_bridge_to_df", return_value=df_mocked
        )
